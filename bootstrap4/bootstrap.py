...
# Default settings
BOOTSTRAP4_DEFAULTS = {
    'jquery_url': '//ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js',
    'tether_url': '//cdnjs.cloudflare.com/ajax/libs/tether/1.2.0/js/tether.min.js',
    'base_url': '//maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.3/',
    'css_url': None,
    'theme_url': None,
    'javascript_url': None,
