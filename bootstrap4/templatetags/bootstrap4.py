...
from bootstrap4.components import render_icon, render_alert
...
from bootstrap4.text import force_text
from bootstrap4.utils import handle_var, parse_token_contents
from bootstrap4.utils import render_link_tag, render_tag, render_template_file
...
@register.simple_tag
def bootstrap_icon(*args, **kwargs):
    """
    Render an icon
    **Tag name**::
        bootstrap_icon
    ...
    **Example**::
        {% bootstrap_icon "star" %}
    """
    return render_icon(*args, **kwargs)
